...
//         await queryRunner.query(`CREATE INDEX "IDX_5be0de38aef377b8ba2bc94606" ON "prescriptions" ("pharmacyId") `);
//         await queryRunner.query(`CREATE INDEX "IDX_5f680454c70e6b2134c5ddc6d1" ON "prescriptions" ("reference") `);
//         await queryRunner.query(`CREATE INDEX "IDX_414e0cee0efdee5a65a2bad9cd" ON "prescriptions" ("status") `);
//         await queryRunner.query(`CREATE INDEX "IDX_807c3cba73fd06d0f2a680821a" ON "prescriptions" ("paymentStatus") `);
//         await queryRunner.query(`CREATE INDEX "IDX_34c9597360c36e1993831cce65" ON "prescriptions" ("createdAt") `);
