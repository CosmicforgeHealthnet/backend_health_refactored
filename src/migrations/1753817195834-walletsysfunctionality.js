...
module.exports = class Walletsysfunctionality1753817195834 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" DROP COLUMN IF EXISTS "transferId"`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" DROP COLUMN IF EXISTS "requiresUserOtp"`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" DROP COLUMN IF EXISTS "transferCode"`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" DROP COLUMN IF EXISTS "paystackResponse"`);
        await queryRunner.query(`ALTER TABLE "doctor_wallets" ADD COLUMN IF NOT EXISTS "walletPassword" character varying(255)`);
        await queryRunner.query(`COMMENT ON COLUMN "doctor_wallets"."walletPassword" IS 'Hashed password for wallet operations'`);
        await queryRunner.query(`ALTER TABLE "doctor_wallets" ADD COLUMN IF NOT EXISTS "walletPasswordResetToken" character varying(255)`);
        await queryRunner.query(`COMMENT ON COLUMN "doctor_wallets"."walletPasswordResetToken" IS 'Token for wallet password reset'`);
        await queryRunner.query(`ALTER TABLE "doctor_wallets" ADD COLUMN IF NOT EXISTS "walletPasswordResetExpiresAt" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "doctor_wallets" ADD COLUMN IF NOT EXISTS "walletPasswordResetAttempts" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" ADD COLUMN IF NOT EXISTS "otpCode" character varying(6)`);
        await queryRunner.query(`COMMENT ON COLUMN "wallet_withdrawals"."otpCode" IS '6-digit OTP code for withdrawal verification'`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" ADD COLUMN IF NOT EXISTS "otpExpiresAt" TIMESTAMP`);
        await queryRunner.query(`COMMENT ON COLUMN "wallet_withdrawals"."otpExpiresAt" IS 'When the OTP expires'`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" ADD COLUMN IF NOT EXISTS "otpAttempts" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`COMMENT ON COLUMN "wallet_withdrawals"."otpAttempts" IS 'Number of OTP attempts made'`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" ADD COLUMN IF NOT EXISTS "maxOtpAttempts" integer NOT NULL DEFAULT '3'`);
        await queryRunner.query(`COMMENT ON COLUMN "wallet_withdrawals"."maxOtpAttempts" IS 'Maximum allowed OTP attempts'`);
        await queryRunner.query(`ALTER TABLE "wallet_withdrawals" ADD COLUMN IF NOT EXISTS "isOtpVerified" boolean NOT NULL DEFAULT false`);
