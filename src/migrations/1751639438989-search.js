...
module.exports = class Search1751639438989 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b9ed845f64d320e335caee62d3" ON "search_logs" ("query") `);
        await queryRunner.query(`CREATE INDEX "IDX_8185b39c539ce71478d7604bbd" ON "search_logs" ("userRole") `);
        await queryRunner.query(`CREATE INDEX "IDX_bac4164acefd9d64d941eae63a" ON "search_logs" ("timestamp") `);
