...
module.exports = class CreateVerificationTables1749389539743 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "idx_verification_reviewer" ON "verification_requests" ("assignedReviewerId") `);
        await queryRunner.query(`CREATE INDEX "idx_verification_created" ON "verification_requests" ("createdAt") `);
        ...
        await queryRunner.query(`CREATE INDEX "idx_document_verification_type" ON "verification_documents" ("verificationRequestId", "documentType") `);
        await queryRunner.query(`CREATE INDEX "idx_document_status" ON "verification_documents" ("status") `);
        await queryRunner.query(`CREATE INDEX "idx_document_hash" ON "verification_documents" ("fileHash") `);
        await queryRunner.query(`CREATE INDEX "idx_document_uploaded" ON "verification_documents" ("uploadedAt") `);
        await queryRunner.query(`CREATE TABLE "verification_status_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "verificationRequestId" uuid NOT NULL, "fromStatus" character varying, "toStatus" character varying NOT NULL, "changedBy" uuid NOT NULL, "changeReason" text, "metadata" jsonb, "automatedChange" boolean NOT NULL DEFAULT false, "changedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f46a2ebf1b77443a0f3bd928ba0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_status_history_verification" ON "verification_status_history" ("verificationRequestId") `);
        await queryRunner.query(`CREATE INDEX "idx_status_history_changed" ON "verification_status_history" ("changedAt") `);
        await queryRunner.query(`CREATE INDEX "idx_status_history_user" ON "verification_status_history" ("changedBy") `);
