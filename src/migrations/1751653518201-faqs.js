...
module.exports = class Faqs1751653518201 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."faqs_targetrole_enum" AS ENUM('patient', 'doctor', 'general', 'all')`);
        await queryRunner.query(`CREATE TYPE "public"."faqs_status_enum" AS ENUM('draft', 'published', 'archived')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8d36b9ca96f9c1f590431379f1" ON "faqs" ("slug") `);
        await queryRunner.query(`CREATE INDEX "IDX_827f313802faea681bd15c7817" ON "faqs" ("targetRole") `);
        await queryRunner.query(`CREATE INDEX "IDX_ec69ef8e48f54e2b8899131c86" ON "faqs" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_7809bacb3493f6d80bcf26f412" ON "faqs" ("isStatic") `);
        await queryRunner.query(`CREATE INDEX "IDX_ae693878c4fc0f78238f11d7ea" ON "faqs" ("priority") `);
        await queryRunner.query(`CREATE INDEX "IDX_c2f253ed34996b12cf17d261a0" ON "faqs" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_32f9825c80ee38dc4beb5d9b81" ON "faqs" ("publishedAt") `);
        await queryRunner.query(`CREATE TYPE "public"."faq_categories_targetrole_enum" AS ENUM('patient', 'doctor', 'general', 'all')`);
        await queryRunner.query(`CREATE TABLE "faq_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(200) NOT NULL, "slug" character varying(250) NOT NULL, "description" text, "icon" character varying(100), "color" character varying(50), "targetRole" "public"."faq_categories_targetrole_enum" NOT NULL DEFAULT 'general', "isActive" boolean NOT NULL DEFAULT true, "sortOrder" integer NOT NULL DEFAULT '0', "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_115c461144a448df2077e558412" UNIQUE ("slug"), CONSTRAINT "PK_c3a7f838a99baed5cbcbc5372db" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_115c461144a448df2077e55841" ON "faq_categories" ("slug") `);
        await queryRunner.query(`CREATE INDEX "IDX_8c34adac00bcbbe53daf82523e" ON "faq_categories" ("targetRole") `);
        await queryRunner.query(`CREATE INDEX "IDX_41fb4cb0a41ba49b17555a9aa0" ON "faq_categories" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_60a665bcd23f90bb671289a321" ON "faq_categories" ("sortOrder") `);
        await queryRunner.query(`CREATE TYPE "public"."faq_votes_votetype_enum" AS ENUM('helpful', 'not_helpful')`);
        await queryRunner.query(`CREATE TABLE "faq_votes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "faqId" uuid NOT NULL, "userId" uuid, "voteType" "public"."faq_votes_votetype_enum" NOT NULL, "userRole" character varying(50), "ipAddress" character varying(45), "userAgent" text, "feedback" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a0c99323bba22486be5edf45083" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_49fbb79f24356992363e288e63" ON "faq_votes" ("faqId", "userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ac8cc750d47a5fea0bcd6e3482" ON "faq_votes" ("voteType") `);
        await queryRunner.query(`CREATE INDEX "IDX_58df1c6b7577b9264d530d6b87" ON "faq_votes" ("userRole") `);
        await queryRunner.query(`CREATE INDEX "IDX_492d829f85fc7237a28bfa411d" ON "faq_votes" ("createdAt") `);
        await queryRunner.query(`CREATE TYPE "public"."faq_analytics_eventtype_enum" AS ENUM('view', 'search', 'vote', 'share')`);
        await queryRunner.query(`CREATE TABLE "faq_analytics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "eventType" "public"."faq_analytics_eventtype_enum" NOT NULL, "userRole" character varying(50), "searchQuery" character varying(500), "resultPosition" integer, "sessionId" character varying(100), "ipAddress" character varying(45), "userAgent" text, "referrer" character varying(500), "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "faqId" uuid, "userId" uuid, CONSTRAINT "PK_75f3ce5f3c94418e040ea330165" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e9bc0a8cf1e90b0b41774c0e51" ON "faq_analytics" ("eventType") `);
        await queryRunner.query(`CREATE INDEX "IDX_176620290175147533a0b66bd4" ON "faq_analytics" ("userRole") `);
        await queryRunner.query(`CREATE INDEX "IDX_98a967d0ae1b9f493bd6e9736d" ON "faq_analytics" ("searchQuery") `);
        await queryRunner.query(`CREATE INDEX "IDX_c8dca2130511a536f3b4197b60" ON "faq_analytics" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_f1613ba364ce83a0219458c557" ON "faq_analytics" ("sessionId") `);
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "autoBillingEnabled" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "preferredPaymentMethodId" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "autoBillingFailureCount" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "lastAutoBillingAttempt" TIMESTAMP`);
        await queryRunner.query(`COMMENT ON COLUMN "subscriptions"."lastAutoBillingAttempt" IS 'When auto-billing was last attempted'`);
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD "autoBillingGracePeriod" integer NOT NULL DEFAULT '7'`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD "isAutoBilling" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "user_payment_methods" ADD "canAutoCharge" boolean NOT NULL DEFAULT true`);
        ...
        await queryRunner.query(`ALTER TABLE "user_payment_methods" ADD "tokenExpiryDate" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "user_payment_methods" ADD "lastAutoBillingUse" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "user_payment_methods" ADD "autoBillingSuccessCount" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "user_payment_methods" ADD "autoBillingFailureCount" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "faqs" ADD CONSTRAINT "FK_fe8c81969cde9cf981451478b0e" FOREIGN KEY ("categoryId") REFERENCES "faq_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "faq_votes" ADD CONSTRAINT "FK_fd449e14960320e8377e2cf8989" FOREIGN KEY ("faqId") REFERENCES "faqs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "faq_votes" ADD CONSTRAINT "FK_9883946e89376a3d67e40a9171b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
