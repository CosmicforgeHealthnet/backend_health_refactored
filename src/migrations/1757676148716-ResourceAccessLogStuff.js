...
module.exports = class ResourceAccessLogStuff1757676148716 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "resource_access_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "resource_type" character varying NOT NULL, "user_id" uuid NOT NULL, "access_type" "public"."resource_access_logs_access_type_enum" NOT NULL, "ip_address" character varying, "user_agent" text, "accessed_at" TIMESTAMP NOT NULL DEFAULT now(), "metadata" jsonb, CONSTRAINT "PK_0e93e87ae741c29a75c15a5bf00" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_RESOURCE_ACCESS_TYPE" ON "resource_access_logs" ("resource_type") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_RESOURCE_ACCESS_USER" ON "resource_access_logs" ("user_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_RESOURCE_ACCESS_TIME" ON "resource_access_logs" ("accessed_at") `);
